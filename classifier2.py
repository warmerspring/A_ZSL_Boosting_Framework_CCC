...
class CLASSIFIER:
    ...
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=20,
        ...
        if generalized:
            self.acc_fc_seen, self.acc_fc_unseen, self.acc_fc_H, self.acc_first_seen, self.acc_first_unseen, \
            self.acc_first_H, self.best_classifier = self.fit()
        else:
            self.first_acc, self.acc_knn, self.acc_fc, self.best_classifier = self.fit_zsl()
    ...
    def fit_zsl(self):
        ...
        sys.stdout.flush()
        return first_acc, acc_knn, acc_fc, best_classifier
    ...
    def fit(self):
        ...
        sys.stdout.flush()
        return acc_fc_seen, acc_fc_unseen, acc_fc_H, acc_first_seen, acc_first_unseen, acc_first_H, best_classifier
